...
func fitGPULayers(m catalog.Model, ctx int, cfg config.Config) (layers, totalLayers int, ok bool) {
...
func planOffload(m catalog.Model, ctx int, cfg config.Config) OffloadPlan {
...
func resolveOffload(cfg config.Config) OffloadPlan {
...
func RenderGPUSection(cfg config.Config) string {
